using Course.MVC.Models;
using Course.MVC.Services.Interfaces;
...
namespace Course.MVC.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<Response<bool>> SignIn(SignInViewModel signInViewModel)
        {
            ...
            await _httpContxtAccessor.HttpContext.SignInAsync(CookieAuthenticationDefaults.AuthenticationScheme, claimsPrincipal, authenticationProperties);
